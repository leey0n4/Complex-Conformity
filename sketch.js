...
let cellsTarget = boidsCount / 10;
let cellsPerSide = Math.sqrt(cellsTarget);

cols = floor(cellsPerSide * (width / height));
rows = floor(cellsPerSide * (height / width));
...
gradient.addColorStop(0.7, 'rgba(0,255,255,0.05)');
